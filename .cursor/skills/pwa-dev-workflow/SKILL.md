...
2. 確認需求是否屬於維護或後續可選方向（見 AGENTS §後續可選方向）。
...
- **專案已結案**：主畫面、三功能 CRUD、localStorage、PWA 部署與離線、筆記圖片（IndexedDB）、查看模式、刪除確認、共用表單、JSON 匯出匯入、PWA-SCROLL、PWA-LAYOUT。
- **已知未解**：無。
- **後續可選**：備份納入圖片 blob、使用者指定新功能。
